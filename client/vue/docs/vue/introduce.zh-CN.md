...
```jsx
import Vue from 'vue';
import { SmUsers } from 'ant-design-vue';
Vue.use(SmUsers);
```
...
- 手动引入
  ...
  ```jsx
  import SmUsers from 'smweb-module/lib/sm-users'; // 加载 JS
  import 'smweb-module/lib/sm-users/style/css'; // 加载 CSS
  // import 'smweb-module/lib/sm-users/style';         // 加载 LESS
  ```
