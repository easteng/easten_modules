...
```jsx
import Vue from 'vue';
import { SmUsers } from 'smweb-module';
Vue.use(DatePicker);
```
...
```jsx
import 'snweb-module/dist/snweb-module.css'; // or 'snweb-module/dist/snweb-module.less'
```
...
- Use [babel-plugin-import](https://github.com/ant-design/babel-plugin-import) (Recommended)
  ...
  {
    "plugins": [
      ["import", { "libraryName": "sm-uers", "libraryDirectory": "es", "style": "css" }] // `style: true` for less
    ]
  }
  ```
...
- Manually import
  ...
  ```jsx
  import SmUsers from 'smweb-module/lib/sm-users'; // for js
  import 'smweb-module/lib/sm-users/style/css'; // for css
  // import 'smweb-module/lib/sm-users/style';         // that will import less
  ```
