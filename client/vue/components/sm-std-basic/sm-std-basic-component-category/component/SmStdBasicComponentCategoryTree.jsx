          ...
          if (array.some(item => item.id == data.id)) {
            array.map(item => {
              if (item.id == data.id) {
                ...
                item.componentCategoryRltProductCategories=data.componentCategoryRltProductCategories;
          ...
          <div class="tree-body">
            <div class="std-tree" >
              ...
              <div class="std-tree-search">
                <a-input-search placeholder="请输入组件名称或组件编码" loading={this.loading} enter-button onSearch={item => this.onSearch(item)} />
              </div>
